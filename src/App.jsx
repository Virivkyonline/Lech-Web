...
const defaultModules = {
  ...
  menuSettings: {
    ...
    items: [
      ...
      { title: "Ako nakupovať", url: "#info", visible: true, mobile: true },
  ...
  links: {
    enabled: true,
    items: [
      { title: "Ako nakupovať", url: "#info", visible: true, footer: true },
      { title: "Obchodné podmienky", url: "#", visible: true, footer: true },
  ...
  categoriesAdvanced: {
    enabled: true,
    items: [
      { title: "Hlavná kategória", url: "#produkty", customerVisible: true, menuVisible: true, googleIndex: true, productsEnabled: true },
      { title: "Akčný tovar", url: "#produkty", customerVisible: true, menuVisible: true, googleIndex: true, productsEnabled: true },
      { title: "Novinky", url: "#produkty", customerVisible: true, menuVisible: true, googleIndex: true, productsEnabled: true },
    ],
  },
  customerFields: {
    enabled: true,
